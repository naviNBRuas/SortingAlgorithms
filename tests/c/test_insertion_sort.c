...
#include <assert.h>
#include <string.h>
#include "../../src/c/insertion_sort.h"

// Include the insertion sort function from the source file
...
void insertion_sort_test_wrapper(int arr[], int n) {
    ...
    insertion_sort(arr, n, dummy_trace_file);
...
void test_empty_array() {
    ...
    int expected[] = {};
    int n = 0;
    insertion_sort_test_wrapper(arr, n);
