...
#include <assert.h>
#include <string.h>
#include "../../src/c/bubble_sort.h"

// Include the bubble sort function from the source file
...
void bubble_sort_test_wrapper(int arr[], int n) {
    ...
    bubble_sort(arr, n, dummy_trace_file);
...
void test_empty_array() {
    ...
    int expected[] = {};
    int n = 0;
    bubble_sort_test_wrapper(arr, n);
