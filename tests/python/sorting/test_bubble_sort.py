...
def test_bubble_sort_sorted():
    arr = [1, 2, 3, 4, 5]
    assert np.array_equal(bubble_sort(arr), [1, 2, 3, 4, 5])
...
def test_bubble_sort_duplicates():
    arr = [5, 4, 3, 5, 1]
    assert np.array_equal(bubble_sort(arr), [1, 3, 4, 5, 5])

def test_bubble_sort_random():
    arr = [64, 34, 25, 12, 22, 11, 90]
    assert np.array_equal(bubble_sort(arr), [11, 12, 22, 25, 34, 64, 90])
