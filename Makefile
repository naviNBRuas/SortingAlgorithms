...
SRCS = bubble_sort.c insertion_sort.c selection_sort.c merge_sort.c quick_sort.c bogo_sort.c

# Add your C test source files here
TEST_SRCS = tests/c/test_bubble_sort.c tests/c/test_insertion_sort.c tests/c/test_selection_sort.c tests/c/test_merge_sort.c tests/c/test_quick_sort.c tests/c/test_bogo_sort.c

# Executable names
TARGETS = $(SRCS:.c=.out)
TEST_TARGETS = tests/c/test_bubble_sort.test tests/c/test_insertion_sort.test tests/c/test_selection_sort.test tests/c/test_merge_sort.test tests/c/test_quick_sort.test tests/c/test_bogo_sort.test
